export type Section = 'overview' | 'news' | 'schools' | 'departments' | 'jobs' | 'recruitment' | 'hero' | 'chairman' | 'institute' | 'home' | 'forms' | 'contact' | 'complaints' | 'contactMessages' | 'heroBackgrounds' | 'governorates' | 'admissionSettings' | 'admissionApplications' | 'modifications' | 'alumni' | 'settings';
...
export const UI: Record<Lang, Record<string, string>> = {
    en: {
        ...
        admissionApplicationsManage: 'View and manage school admission applications',
        ...
        topComplaintSchools: 'Top Schools by Complaints',
        filterBySchool: 'Filter by School',
        filterByGov: 'Filter by Governorate',
    ...
    ar: {
        ...
        requestId: 'رقم الطلب',
        admissionApplications: 'طلبات الالتحاق',
        admissionApplicationsManage: 'عرض وإدارة طلبات الالتحاق بالمدارس',
        ...
        topComplaintSchools: 'أكثر المدارس شكاوى',
        filterBySchool: 'فلتر بالمدرسة',
        filterByGov: 'فلتر بالمحافظة',
        allSchools: 'جميع المدارس',
        allGovs: 'جميع المحافظات',
        complaintsCount: 'شكاوى',
